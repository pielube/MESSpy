...
class PV:    
    ...
    def __init__(self,parameters,general,simulation_hours,location_name):
        ...
        ### If PV series have already been downloaded and saved in a previous simulation these file.csv are used
        ### Otherwise new series are downloaded from PVgis (type meteorological year)
